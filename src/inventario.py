...
class Inventario:
    def __init__(self, root, abrir_menu_callback):
        ...
        # Frame buscador
        self.frame_buscador = tk.Frame(self.root, padx=60, pady=20, bg='#FFFFFF', relief='flat')
        self.frame_buscador.place(relx=0.5, rely=0.1, anchor='n')
        
        self.entry_buscador = tk.Entry(self.frame_buscador, width=25, font=self.tipografia_texto, relief='solid')
        self.entry_buscador.grid(row=1, column=0, pady=5)
        
        self.label_buscador = tk.Button(self.frame_buscador, text='🔍', font=self.tipografia_texto, fg='#000000', bg='#FFFFFF', relief='flat')
        self.label_buscador.grid(row=1, column=1, padx=5, pady=5)
